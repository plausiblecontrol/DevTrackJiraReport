...
namespace WRPriorityReport {
  public class WR {
    ...
    //Don't add too many objects, if this fails the whole query fails. Need to do this differently, but would need to rewrite the JSON parser [not gonna happen].
  }
  public class Jissues {
    public Jfields fields { 
      get; 
      set; 
    }
  ...
  public class Jfields {
    ...
    public customField customfield_12100 { get; set; } //Request Status "Accepted & Planned"         *****ADDED******
    ...
    public string customfield_12101 { get; set; }//requested date "2015-01-16T16:47:29.000-0600"     *****ADDED******
    ...
    public List<string> customfield_10410 { get; set; }//projects
    ...
    public string duedate { get; set; }//planned due date "2014-12-10"   *****ADDED******
  }
